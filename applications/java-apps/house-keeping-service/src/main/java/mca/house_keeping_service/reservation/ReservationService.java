...
public class ReservationService {
    ...
    public ReservationService(ReservationRepository reservRepo, EstablishmentRepository estabRepo, RoomTypeRepository roomTypeRepo) {
    ...
    private ReservationDTO mapToDTO(Reservation reservation) {
        ...
        reservation.getRoomTypes().forEach((roomType, quantity) ->     
            resDTO.addRoomType(roomType.getId(), quantity));
    ...
    public UUID create(@Valid ReservationReqDTO reservationReqDTO) {
        Establishment establishment = 
            estabRepo.findById(reservationReqDTO.getEstablishmentId())
