...
class ApiUser(HttpUser):
    ...
    def on_start(self):
        ...
        self.establishment_id = "00000000-0000-0000-0000-000000000001"
        self.room_type_id = self.get_room_type_id()

    
    def get_room_type_id(self):
        response = self.client.get(f"/api/v1/establishments/{self.establishment_id}/room-types")
    ...
    def create_reservation(self):
        ...
        self.client.post("/api/v1/reservation", json=reservation)

    @task
    def get_room_rack(self):
        self.client.get(f"/api/v1/establishments/{self.establishment_id}/rooms")
